...
function Carrito() {
    const { cart, incrementarCantidad, decrementarCantidad, vaciarCarrito, comprar } = useContext(cartContext);
        ...
        <>
            ...
            {cart.length > 0 &&
                <div>
                    ...
                    <div className="d-flex justify-content-center pb-3">
                        <button className="btn btn-danger me-2" onClick={() => vaciarCarrito()}>Vaciar Carrito</button>
                        <button className="btn btn-success ms-2" onClick={() => comprar()}>Comprar</button>
                    </div>
                </div>
            }
        </>
